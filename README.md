...
Technology Stack
- Frontend: React with Context API ➡️ [Repo](https://github.com/kellywslee/PupPals-Frontend)
- Backend: Express.js & MySQL ➡️ [Repo](https://github.com/kellywslee/PupPals-Backend)
